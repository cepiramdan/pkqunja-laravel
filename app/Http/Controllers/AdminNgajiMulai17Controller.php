<?php namespace App\Http\Controllers;
	...
	class AdminNgajiMulai17Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Waktu Mulai","name"=>"waktu_mulai"];
			$this->col[] = ["label"=>"Waktu Selesai","name"=>"id","join"=>"ngaji_selesai,waktu_selesai"];
			$this->col[] = ["label"=>"Surah Mulai","name"=>"surah_mulai"];
			$this->col[] = ["label"=>"Surah Selesai","name"=>"id","join"=>"ngaji_selesai,surah_selesai"];
			$this->col[] = ["label"=>"Ayat Mulai","name"=>"ayat_mulai"];
			$this->col[] = ["label"=>"Ayat Selesai","name"=>"id","join"=>"ngaji_selesai,ayat_selesai"];
			...
			$this->form[] = ['label'=>'Ayat Selesai','name'=>'id','type'=>'number','validation'=>'required','width'=>'col-sm-9'];
